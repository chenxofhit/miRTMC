function [X1,m]=armijo_ls_spd(X0,grad,dir,alpha,beta,sigma,mmax,retraction,matrices)
...
cost0=karcher_cost(X0,matrices);
...
if (any(any(isnan(X1))))
    ...
    dist_decrease=cost0-karcher_cost(X1,matrices);
end
